...
class Settings(BaseSettings):
    ...
    stt_enabled: bool = True; stt_model_size: str = "small"; stt_wake_model_size: str = "tiny"; stt_language: str = "pt"; stt_device: str = "cpu"; stt_wake_device: str = "cpu"; stt_compute_type: str = "float16"; stt_initial_prompt: str = ""; stt_beam_size: int = 1; stt_best_of: int = 1; stt_temperature: float = 0.0
