...
class Settings(BaseSettings):
    ...
    stt_enabled: bool = True; stt_model_size: str = "small"; stt_wake_model_size: str = "tiny"; stt_language: str = "pt"; stt_device: str = "cuda"; stt_wake_device: str = "cpu"; stt_compute_type: str = "float16"; stt_initial_prompt: str = ""; stt_beam_size: int = 1; stt_best_of: int = 1; stt_temperature: float = 0.0
    stt_vad_filter: bool = False; stt_vad_min_silence_ms: int = 500
    stt_capture_silence_pad: float = 1.25; stt_capture_min_speech_duration: float = 0.35; stt_capture_abs_threshold: float = 250.0; stt_capture_noise_floor_multiplier: float = 2.2; stt_capture_frame_duration: float = 0.05; stt_capture_speech_confirm_frames: int = 2
    ...
    tts_enabled: bool = True; tts_voice: str = ""; tts_speed: float = 1.0; tts_device: str = "cuda"; tts_streaming: bool = True; tts_emotion_enabled: bool = True; tts_default_emotion: str = "neutral"; tts_emotion_max_intensity: float = 1.0; tts_emotion_decay_seconds: float = 60.0
